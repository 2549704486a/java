...
DROP TABLE IF EXISTS `agent_tool_observation`;
DROP TABLE IF EXISTS `agent_request_observation`;
...
CREATE TABLE `agent_request_observation` (
...
CREATE TABLE `agent_tool_observation` (
  `request_id` varchar(128) CHARACTER SET ascii COLLATE ascii_bin NOT NULL,
